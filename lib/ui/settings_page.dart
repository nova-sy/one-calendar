...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget _feishuSection() {
    ...
    return _section(s.feishuSection, Icons.cloud_outlined, [
      ...
      SelectableText(s.redirectUriHint, style: const TextStyle(fontSize: 12, color: Colors.grey)),
      const SizedBox(height: 10),
      Row(children: [
  ...
  Widget _rulesSection() {
    ...
    return _section(s.syncRulesSection, Icons.tune, [
      ...
      Text(s.rulesAutoSaved, style: const TextStyle(fontSize: 11, color: Colors.grey)),
    ]);
  }
